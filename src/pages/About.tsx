    ...
    <div className="min-h-screen bg-cream-50">
      ...
      <section className="py-luxury-8 px-luxury-2">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white p-luxury-4 rounded-lg shadow-sm mb-luxury-6">
            <h2 className="font-playfair text-4xl text-sage-600 mb-luxury-3 font-normal text-center">
              Our Story
            </h2>
            <div className="space-y-luxury-3 font-cormorant text-lg md:text-xl text-charcoal-500 leading-relaxed">
              <p>
          ...
          <div className="bg-white p-luxury-4 rounded-lg shadow-sm">
            ...
            <div className="grid md:grid-cols-2 gap-luxury-4">
